...
class DatabaseManager {
    ...
    async createCoreTables() {
        // Main data table - stores all OHLCV and OI data **WORRIED about *"Primary Key, source"-below
        try {
    ...
    async insertFixedPerpspecSchemas() {
        const fixedSchemas = [
            ...
            { name: 'bin-pfr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'pfr'] },
            { name: 'byb-pfr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'pfr'] },
            { name: 'okx-pfr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'pfr'] },
            { name: 'bin-lsr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'lsr'] },
            { name: 'byb-lsr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'lsr'] },
            { name: 'okx-lsr', fields: ['ts', 'symbol', 'source', 'perpspec', 'interval', 'lsr'] }
